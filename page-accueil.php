    ...
    <div class="main-area">
            ...
            <section class="slider">
                ...
                <div class="flexslider">
                    <ul class="slides">
                        ...
                        ?>
                            <li>
                                <?php the_post_thumbnail( 'tout-mobile-slider', array( 'class' => 'img-fluid' )); ?>
                                <div class="container">
		...
		?>
			<section class="popular-products">
				...
				<div class="container">
					<div class="section-title">
						<h2><?php echo esc_html( get_theme_mod( 'set_popular_title', __( 'Produits populaires', 'fancy-lab' ) ) ); ?></h2>
					</div>
					<?php 
			...
			<section class="new-arrivals">
				<div class="container">
					<div class="section-title">
						<h2><?php echo esc_html( get_theme_mod( 'set_new_arrivals_title', __( 'Nouveautés', 'fancy-lab' ) ) ); ?></h2>
					</div>
					<?php 
		...
		<section class="lab-blog">
			<div class="container">
				<div class="section-title">
					<h2><?php echo esc_html( get_theme_mod( 'set_blog_title', __( 'Nouveaux articles', 'fancy-lab' ) ) ); ?></h2>
				</div>
				<div class="row">
					<?php
					$args = array(
